find . -name "*.html" -type f -exec sed -i '' -e 's/main20210519.css/main20210813.css/g' {} \;
mv css/main20210519.css css/main20210813.css;
...
find . -name "*.html" -type f -exec sed -i '' -e 's/sbn-header20210331.html/sbn-header20210813.html/g' {} \;
mv sbn-header20210331.html sbn-header20210813.html;
